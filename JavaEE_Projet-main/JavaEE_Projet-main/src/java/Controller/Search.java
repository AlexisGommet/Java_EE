...
public class Search extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Integer searchType = Integer.parseInt(request.getParameterValues("searchType")[0]);

            ArrayList<User> userSearch = User.searchUsers(con, search, searchType);
            
            request.setAttribute("parameters", userSearch);
